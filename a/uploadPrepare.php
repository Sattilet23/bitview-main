...
if (!isset($_POST["title"], $_POST["description"], $_POST["category"], $_POST["day"], $_POST["address"], $_POST["month"], $_POST["year"], $_POST["country"], $_POST["tags"])) { die("1"); }


$file = $DB->execute(
    "SELECT vid FROM videos_uploads WHERE username = :USERNAME AND videos_uploads.vid = :VIDEO_ID LIMIT 1", 
    true, 
    [
...
if ($file) {
    ...
    if (!isset($Countries[$_POST["country"]])) {
    ...
    if (!isset($_CONFIG::$Categories[$_POST["category"]])) { $_POST["category"] = 1; }



    $DB->modify("UPDATE videos SET
