...
<title>BitView - <?php if (!isset($_PAGE["ChannelTitle"])) : ?>Your Digital Video Repository<?php else : ?><?= $_PAGE["ChannelTitle"] ?><?php endif ?></title>
<link rel="stylesheet" type="text/css" href="/css/main_channel.css">
