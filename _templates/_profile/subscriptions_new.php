...
<?= $LANGS['subscriptions'] ?>
					(<span name="channel-box-item-count"><?php if ($LANGS['numberformat'] == 1): ?><?= number_format($_PROFILE->Info["subscriptions"]) ?><?php else: ?><?= ($_PROFILE->Info["subscriptions"]) ?><?php endif ?></span>)
		</div>
...
<?php if ($Users_Subscriptions3) : ?>
	<div style="zoom:1;margin: 0 -12px">
				<?php foreach ($Users_Subscriptions3 as $Subscriber) : ?>
