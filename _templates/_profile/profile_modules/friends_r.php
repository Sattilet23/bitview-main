<?php if ($_PROFILE->Info['c_friends_box'] == 1): ?>
	<?php $Limit = $_PROFILE->Info['c_friends_rows'] * 7 * 2; ?>
...
<?= $LANGS['friends'] ?>
		...
		<?php if ($_PROFILE->Username == $_USER->Username): ?><div class="updown_arrows "><img id="user_friends-left-arrow" src="/img/pixel.gif" class="module-left-arrow " onclick="move_left('friends')"><img id="user_friends-up-arrow" src="/img/pixel.gif" class="module-up-arrow <?php if ($Modules_R[0] == "friends"): ?> disabled<?php endif ?>" onclick="move_up('friends');return false"><img id="user_friends-down-arrow" src="/img/pixel.gif" class="module-down-arrow <?php if (end($Modules_R) == "friends"): ?>disabled<?php endif ?>" onclick="move_down('friends');return false"><img id="user_friends-right-arrow" src="/img/pixel.gif" class="module-right-arrow disabled"></div><?php endif ?>
