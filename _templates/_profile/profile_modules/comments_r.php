...
<?= $LANGS['channelcomments'] ?>
					(<span name="channel-box-item-count" id="channel-box-item-count"><?= $_PROFILE->Info["channel_comments"] ?></span>)
		</div>
		<div style="float:right;zoom:1;_display:inline;white-space:nowrap">
			<div style="float:right">
				<?php if ($_PROFILE->Username == $_USER->Username): ?><div class="updown_arrows "><img id="user_comments-left-arrow" src="/img/pixel.gif" class="module-left-arrow " onclick="move_left('comments')"><img id="user_comments-up-arrow" src="/img/pixel.gif" class="module-up-arrow <?php if ($Modules_R[0] == "comments"): ?> disabled<?php endif ?>" onclick="move_up('comments');return false"><img id="user_comments-down-arrow" src="/img/pixel.gif" class="module-down-arrow <?php if (end($Modules_R) == "comments"): ?>disabled<?php endif ?>" onclick="move_down('comments');return false"><img id="user_comments-right-arrow" src="/img/pixel.gif" class="module-right-arrow disabled"></div><?php endif ?>
...
<?php endif ?>
<div class="box-bg box-fg inner-box loading-div" style="display:none;"><table cellspacing="0" cellpadding="0" width="616" height="699"><tbody><tr><td align="center" valign="middle"><img src="/img/icn_loading_animated.gif"></td></tr></tbody></table></div>
