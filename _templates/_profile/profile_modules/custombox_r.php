...
<?php if ($_PROFILE->Username == $_USER->Username): ?><div class="updown_arrows "><img id="user_branding-left-arrow" src="/img/pixel.gif" class="module-left-arrow " onclick="move_left('branding')"><img id="user_branding-up-arrow" src="/img/pixel.gif" class="module-up-arrow <?php if ($Modules_R[0] == "custombox"): ?> disabled<?php endif ?>" onclick="move_up('branding');return false"><img id="user_branding-down-arrow" src="/img/pixel.gif" class="module-down-arrow <?php if (end($Modules_R) == "custombox"): ?>disabled<?php endif ?>" onclick="move_down('branding');return false"><img id="user_branding-right-arrow" src="/img/pixel.gif" class="module-right-arrow disabled"></div><?php endif ?>
