...
<div style="overflow:hidden;width:auto;margin:0 auto">
    <h2 style="margin:0 0 2px"><?= $LANGS['createplaylisttitle'] ?></h2>
    ...
    <form action="/create_playlist" method="POST">
        <table cellpadding="4px" style="position:relative;right:4px">
            ...
            <tr>
                ...
                <td><textarea name="description" maxlength="500" cols="50" rows="4"></textarea></td>
            </tr>
            <tr>
                <td><b><?= $LANGS['tags']?>:</b></td>
                <td><input type="text" name="tags" maxlength="256"></td>
            </tr>
            <tr>
                <td colspan="2"><input type="submit" class="yt-button yt-button-primary" name="create_playlist" value="<?= $LANGS['createplaylist']?>"> <a href="/my_playlists"><button class="yt-button yt-button-primary" type="button"><?= $LANGS['cancel']?></button></a></td>
            </tr>
        </table>
    </form>
</div>
