...
<div id="vm-title"><?= $LANGS['favorites'] ?></div>
<div id="vm-layout-left">
    <ol class="vm-vertical-nav">
        ...
        <li><a class="selected" href="/my_favorites"><?= $LANGS['favorites'] ?></a></li>
...
<div id="vm-layout-right">
    ...
    <div id="vm-video-actions-bar" class="goog-scrollfloater">
        ...
        <input type="checkbox" id="vm-video-select-all" onchange="checkAll(this);">
            <button type="button" id="vm-playlist-copy-to" onclick="openAddTo();return false;" class=" yt-uix-button" data-button-menu-id="vm-videos-copyto-dialog" disabled=""><span class="yt-uix-button-content"><?= $LANGS['addto'] ?></span> <img class="yt-uix-button-arrow" src="/img/pixel.gif" alt=""></button> <button type="button" id="vm-playlist-remove-videos" onclick="removeVideosFav();return false;" class=" yt-uix-button" disabled=""><span class="yt-uix-button-content"><?= $LANGS['remove'] ?></span></button>
