...
$LANGS['channeltitle'] = "{n}'s Channawl";
...
$LANGS['vidsday'] = 'Yew cannot upload more than 3 videos per 24 hours!';
...
$LANGS['sharechannel'] = 'Share Channawl';
...
$LANGS['subvideos2'] = "'s vidjoes";
$LANGS['plvideos'] = 'Vidjoes';
$LANGS['playall'] = 'Play All';
$LANGS['featuredchannels'] = 'Featured Channawl';
...
$LANGS['nofriends'] = 'No Babbers...';
$LANGS['nobulletins'] = 'No Bulletins...';
$LANGS['novideoschannel'] = 'No Vidjoes...';
$LANGS['nofavs'] = 'No Favourite Vidjoes...';
$LANGS['noplchannel'] = 'No Playlists...';
$LANGS['pvideos'] = 'Private Vidjoes';
$LANGS['pvideosallow'] = 'Yews not allowed to see dose vidjoes...';
$LANGS['plvideoamount'] = 'vidjoes';
...
$LANGS['for'] = 'for';
$LANGS['commentdesc'] = 'Channawl comments appear on the users channawl.';
$LANGS['postbulletin'] = 'Post Bulletin';
$LANGS['writeabulletin'] = 'Write a bulletin';
$LANGS['bulletindesc'] = 'Bulletins appear on your own and yews babbers channawl pages.';
...
$LANGS['activityfavorite'] = 'favorited a vidjoe';
$LANGS['activitylike'] = 'liked a vidjoe';
$LANGS['activityrating'] = 'rated a vidjoe:';
$LANGS['activityupload'] = 'uploaded a new vidjoe';
...
$LANGS['videosandpl'] = "Vidjoes and Playlists";
...
$LANGS['info'] = "Info";
$LANGS['viewcomments'] = "View comments, related vidjoes, and more";
$LANGS['seeallcommentsandresponses'] = "See all comments and vidjoe responses";
...
$LANGS['myuploadedvideos'] = "My Uploaded Vidjoes";
$LANGS['myfavorites'] = "My Favorites";
$LANGS['alsoshowall'] = 'Also show "All" view';
$LANGS['featuredvideo'] = 'Featured vidjoe';
$LANGS['usemostrecent'] = 'Use the most recent vidjoe from my featured set';
$LANGS['autoplayfeatured'] = "Autoplay featured vidjoe";
...
/* My Profile page */
$LANGS['myprofiledesc'] = 'This page contains all of the settings for yews BitView channel.';
...
$LANGS['emailcomm'] = 'E-Mail me on Vidjoe Comments';
...
$LANGS['hlfontcolor'] = 'Ighlight Font Colour';
$LANGS['hlheadercolor'] = 'Ighlight Header';
$LANGS['hlinsidecolor'] = 'Ighlight Inside';
$LANGS['headercolor'] = 'Regular Header';
$LANGS['insidecolor'] = 'Regular Inside';
$LANGS['font'] = 'Channel Font';
$LANGS['featuredvideobox'] = 'Featured Vidjoe Box';
...
$LANGS['chvideoviews'] = 'Vidjoe Views';
$LANGS['change'] = "change";
$LANGS['mynetwork'] = "My Network";
$LANGS['contacts'] = "Contacts";
$LANGS['chvideocomments'] = "Vidjoe Comments";
$LANGS['chmore'] = "More";
...
$LANGS['videoplaybackquality'] = "Vidjoe Playback Quality";
$LANGS['videoplaybackqualitydesc'] = "Choose the default setting for viewing vidjoes";
$LANGS['alwayshd'] = "Always play vidjoes in HD quality";
$LANGS['neverhd'] = "Never play any vidjoes in HD quality";
...
/* Upload page */
$LANGS['uploadpagetitle'] = 'Vidjoe Upload';
$LANGS['step1of2'] = 'Step 1 of 2';
$LANGS['step2of2'] = 'Step 2 de 2';
$LANGS['videocategory'] = 'Vidjoe Category';
$LANGS['tagsdesc'] = 'Tags are keywords used to elp people find yews vidjoe.<br> <i>(comma separated)</i>';
$LANGS['requiredfield'] = '(* indicates required field)';
$LANGS['datemapoptions'] = 'Date and Map Options';
$LANGS['optional'] = '(optionawl)';
$LANGS['chooseoptions'] = 'choose options';
$LANGS['lessoptions'] = 'less options';
$LANGS['addressrecorded'] = 'Address Recorded';
$LANGS['uploadcontinue'] = 'Upload a vidjoe...';
$LANGS['file'] = 'File';
$LANGS['broadcastoptions'] = 'Broadcast Options';
$LANGS['uploadvideo'] = 'Upload Vidjoe';
$LANGS['needfilevideotoupload'] = 'Please select a vidjoe file to upload!';
$LANGS['aboutuploading'] = 'About uploading...';
$LANGS['uploaddesc1'] = 'Uploads usually take 1-5 minutes per MB on a high-speed connexion, and converting yews vidjoe takes a few minutes.';
$LANGS['videolimit1'] = 'Your vidjoe is limited to 100MB - maximum vidjoe length is 15 minutes.';
$LANGS['videolimit2'] = 'Your vidjoe is limited to 2GB - maximum vidjoe length is 15 minutes.';
$LANGS['partnervideolimit1'] = 'Your vidjoe is limited to 100MB - maximum vidjoe length is 30 minutes.';
$LANGS['partnervideolimit2'] = 'Your vidjoe is limited to 2GB - maximum vidjoe length is 30 minutes.';
$LANGS['myvideosdesc'] = 'After uploading yew can edit or remove this vidjoe at anytime under the "<a href="/my_videos">My Vidjoes</a>" link on the top of the page.';
$LANGS['newuploader'] = 'Use the new vidjoe uploader';
$LANGS['olduploader'] = 'Use the old vidjoe uploader';
$LANGS['videoadded'] = 'Your vidjoe was successfully added!';
$LANGS['videoaddeddesc'] = 'Your vidjoe is currently being processed and will be available to view in a few minutes.';
$LANGS['thankyou'] = 'Thank You';
$LANGS['sharelink'] = 'Share your vidjoe link! Copy and paste below:';
$LANGS['embedlink'] = 'Play this vidjoe directly ON yews website! Copy and paste the following snippet:';
...
$LANGS['partnerdesc'] = "yews av gert lush vidjoes and a growing fanbase. Let BitView elp yew take it to the next levawl through our Partner Programme.";
$LANGS['applynow'] = 'Apply now';
$LANGS['contentpartners'] = 'Content Partners';
$LANGS['partnerbenefits'] = 'Partner Benefits';
$LANGS['partnerbenefitsdesc'] = 'There are many benefits to becoming a BitView Partner. Some of them include:<br><br>- Branding: make yewself stand out with custom branding, which includes banners, a custom box for yews channawl and a partner badge on all yews vidjoes.<br><br>- There are more benefits to come in the future!';
$LANGS['qualificationsfaq'] = 'Qualifications & FAQ';
$LANGS['qualificationsfaqdesc'] = 'To qualify for the BitView Partner programme, yew must meet some minimum criteria:<br><br>- Yew create original vidjoes suitable for online streaming.<br><br>- Yew ave >75 subscribers.<br><br>- Yews account does not break any <a href="/guidelines">Community Guidelines.</a>';
...
$LANGS['modsanddevsdesc'] = 'People who keep the website safe and clear. Ave any problem with yews account? Yew should contact them.';
...
$LANGS['letter'] = "Dear Co-Owners, Developers, and Moderators of BitView,<br><br>
                On behalf of the entire BitView team, I would like to express my heartfelt gratitude for yews exceptional dedication and ard work. As one of the owners, it fills me with immense pride to witness the growth and success of our vidjoe-sharing platform, and it would not have been possible without your invaluable contributions.
                <br><br>
                To rest of the Co-Owners, thank yew for yews unwavering support and vision. Yews commitment to the platform's development and improvement as been instrumentawl in shaping BitView.net into the remarkable communitee it is today. Yews leadership and strategic guidance av been vitawl in navigating the challenges and opportunities that av come our way.
                <br><br>
                To our talented Developers, yew technicawl expertise and innovative ideas av transformed BitView into a cutting-edge platform that perfectly represent ow YouTube looked like back in the days. Yews countless hours of coding, problem-solving, and feature implementation have elevated the user experience and made our platform a hub of creativitee and entertainment. Yews dedication to refining the functionality and performance of the site as been truly commendabawl.
                <br><br>
                To our diligent Moderators, I extend me deepest appreciation for maintaining the integrity and safety of our communitee. Yews vigilance in enforcing the rules and guidelines, ensuring respectful interactions, and swiftly addressing any issues that arise has been cruciawl in fostering a welcoming environment for all users. Your efforts in keeping BitView a space for constructive engagement and positive content are highly commendabawl.
                <br><br>
                ...
                <br><br>
                Once again, thank yew: Co-Owners, Developers, and Moderators, for yews unwavering dedication, expertise, and unwavering support. Yews ard work as not gone unnoticed, and I’m incredibly proud to be part of this remarkabawl team.
                <br><br>
                Keep expressing Yewself,<br>
                <3 vistafan12";
$LANGS['backtobitview'] = "Back to BitView";

/* My Friends */
$LANGS['myfriends'] = 'My Babbers';
...
$LANGS['noquicklist'] = "There are no vidjoes in your quicklist.";
$LANGS['noquicklistdesc'] = "QuickList lets you make a vidjoe list for later viewing. Click on the &quot;+&quot; (in the lower left) of any vidjoe to add it to your QuickList. To view your list, look for the QuickList bar under any vidjoe you're watching.";
...
$LANGS['aboutdesc'] = 'BitView is a way to get yews vidjoes to the people who matter to yew. With BitView yew can:';
$LANGS['about1'] = 'Show off yews favourite vidjoes to the world';
$LANGS['about2'] = 'Take vidjoes of yews dogs, cats, and other pets';
$LANGS['about3'] = 'Blog the vidjoes yew take with yews digital camera or mobile';
$LANGS['about4'] = 'Securely and privately show vidjoes to yews friends and family around the world';
...
$LANGS['monthlycontestschedule'] = "Monthly Vidjoe Contest Scheduawl";
...
$LANGS['contestsuggestion'] = 'Ave a suggestion for a monthly vidjoe contest? Please suggest it towards our Matrix.';

/* Help */
$LANGS['q1'] = 'Q: Ow can I share me vidjoes and link to them from me website?';
$LANGS['a1'] = 'A: <a href="/sharing">Ow to share and link to yews vidjoes</a>';
$LANGS['q2'] = 'Q: What kind of vidjoes can I upload?';
$LANGS['a2'] = 'A: You may upload any kind of personal vidjoe that yew would like to share with the world. We do not allow any nudity and yews vidjoe must be appropriate for all audiences.
<br/>
<br/>
However, this still leaves a lot of room for creativitee!! Do yew own a <a href="results?search=dog&t=Search+Videos">dog</a> or a <a href="/results?search=cat&t=Search+Videos">cat</a>? Have yew gone on holiday at <a href="/results?search=Butlins&t=Search+Videos">Butlins</a>? Do yew live in <a href="/results?search=Bristol&t=Search+Videos">Brizzle</a>?
<br/>
<br/>
These are just some examples of the vidjoes that our users are uploading. In the end, yew know yourself best. What would <i>yew</i> like to capture on vidjoe?';
$LANGS['q3'] = 'Q: How long can me vidjoe be?';
$LANGS['a3'] = 'A: The vidjoe must be under 15 minutes long and less than 2GB in size (100MB if you use an old browser).';
$LANGS['q4'] = 'Q: What vidjoe file formats can I upload?';
$LANGS['a4'] = 'A: BitView accepts vidjoe files from most digital camerawl and from mobile phones in the .WMV, .AVI, .MOV, .MPG, .MP4 file formats.';
$LANGS['q5'] = 'Q: How can I improve me vidjoes?';
$LANGS['a5'] = 'A: We encourage you to edit yews vidjoes with software such as <a href="https://windows-movie-maker-vista.en.softonic.com/" target="_blank">Windows Movie Maker</a> (included with every Windows installation), or <a href="https://www.apple.com/lae/imovie/" target="_blank">Apple iMovie</a>. Using these programmes yew can easily edit yews vidjoes, add soundtracks, etc.';
$LANGS['q6'] = 'Q: Do I retain copyrights and other legawl rights to me videos?';
$LANGS['a6'] = 'A: Yes. Yew retain all rights to yews content. BitView assumes no copyright to yews material.';
$LANGS['q7'] = 'Q: What is yews policy on copyright infringement?';
$LANGS['a7'] = "A: BitView respects the rights of copyright holders and publishers and is only accepting vidjoe uploads from persons who old all necessary rights to the uploaded materiawl. Our policee is to respond to any notices of alleged infringement that comply with the Digital Millennium Copyright Act (DMCA). If we receive a notice or otherwise have reason to believe that content yew submitted infringes another party's copyright, yews account may be terminated and the vidjoe removed from BitView.";
$LANGS['q8'] = 'Q: How do I report copyright infringement?';
$LANGS['a8'] = 'A: If yew believe that someone else has uploaded yews copyrighted content without yews permission, we encourage yew to contact that person in order to resolve any differences with them directly. Yew can also contact our support team using this <a href="sks2002@sks2002.com">email</a>.';
$LANGS['q9'] = 'Q: What if I ave been falsely accused of copyright infringement?';
$LANGS['a9'] = "A: We'll let yews know if we receive a copyright complaint about any of yews vidjoe content that is hosted on BitView. We'll give you the opportunitee to respond appropriatlee.";
$LANGS['q10'] = 'Q: What are yews doing to prevent content that violates yews policies from appearing in BitView?';
$LANGS['a10'] = 'A: We do a preliminary review on uploaded vidjoes through both a manual and automated process. Although we try our best to detect and remove vidjoes that violate our policy guidelines, our review process is primarily focused on removing adult content or obvious copyright violations, and is not bulletproof. However, we encourage our viewers to notify us when they discover policy violations or copyright issues -- we ave a process for reviewing reported policy violations, and respond to reported copyright violations under the Digital Millennium Copyright Act.';
$LANGS['q11'] = 'Q: Do yew have a Matrix server or Blips?';
$LANGS['a11'] = 'Yes! We actually have a Matrix server and Blips. Yew can join into the Matrix server by clicking <a href="https://matrix.to/#/#bittoco:matrix.org">here</a>, and follow us on Blips <a href="https://blips.club/Bittoco">here</a>.';
...
$LANGS['flashdisclaimer'] = "<b>Note:</b> BitView's Flash Player is being offered as a compatibility option. If yews browser supports BitView's HTML5 player yew shouldn't enable this option.";

/* BitView on your site */
$LANGS['bvsitetitle1'] = "The Basics";
$LANGS['bvsitetitle2'] = "APIs and User Engagement";
$LANGS['bvsitedesc1'] = 'Whatever presence yew have on the Internet—a large website, a blog, a social network page, or pretty much anything else—there are many ways to integrate BitView into it. From simple vidjoe embeds to our full-powered APIs, you can integrate vidjoe at all levels of technical expertise.';
$LANGS['bvsitedesc2'] = 'Bringing BitView to your site is more than just adding some of the thousands of vidjoes available on BitView. It keeps your visitors interested and allows self-expression and interaction with one of their favorite services. And it brings your site, blog, or page into the BitView vidjoe community — an international network of users, creators, and sites connected through a huge collection of online vidjoes.';
$LANGS['bvsitedesc3'] = "We've highlighted some typical ways of integrating vidjoe content below — just click the arrow next to the question to get the answer. If you have any questions or suggestions, or projects that you would like us to know about, please leave the questions in our <a href='https://matrix.to/#/#bittoco:matrix.org'>Matrix server</a>.";
$LANGS['bvsitesectiontitle1'] = "How do I add a vidjoe to my blog or web page?";
$LANGS['bvsitesectiontitle2'] = "How do I add a vidjoe to my social network page?";
$LANGS['bvsitesectiontitle3'] = "I work for a large blog/web company. How can vidjoe increase user engagement on our site?";
$LANGS['bvsitesectiontitle4'] = "We have a site and we have our own vidjoes. Can we post these on our site using BitView?";
...
$LANGS['bvsitesection1desc2'] = "Next, go to the vidjoe that you want, and look for the 'Embed' box in the &quot;About This Vidjoe&quot; section. Copying the HTML code that's there into your website will create an embedded player; the vidjoe will play within your site when the user clicks on the 'Play' button.";
$LANGS['bvsitesection1desc3'] = "You can resize the player by editing the <em>object width=&quot;425&quot;</em> and  <em>height=&quot;350&quot;</em> fields at both the beginning and end of the embedded player code. Make sure that the sizes you choose have the same ratio as the default numbers, so that the vidjoe doesn't get stretched—just multiply the width by 0.8235 to get the height.";
$LANGS['bvsitesection2desc1'] = "Adding vidjoes to your profiles on social networks like SpaceHey is a great way to share your vidjoes or favorites with friends. Or, if you're promoting something (like your band) on SpaceHey, vidjoes will help attract visitors to your page, who can then then share the link with their friends. The social network sites have similar ways to add vidjoes, so we'll use SpaceHey as an example.";
$LANGS['bvsitesection2desc2'] = 'Sign in to your SpaceHey profile, then click the "Edit Profile" button.';
$LANGS['bvsitesection2desc3'] = "Next, go to the vidjoe that you want, and look for the 'Embed' box in the &quot;About This Vidjoe&quot; section. Copying the HTML code that's there into your website will create an embedded player.";
...
$LANGS['bvsitesection3desc1'] = "Vidjoe is much more engaging than text. It draws more users and keeps them on your site for longer. BitView has a large repository of Internet vidjoe content along with the search, playback and API tools to make adding vidjoe easier for you.";
$LANGS['bvsitesection3desc2'] = "When looking to increase engagement, try using vidjoe as a way to start discussion or make a commentary by creating more context for your users:";
$LANGS['bvsitesection4desc1'] = "It's very easy to build out your own site with your own vidjoes for free. All you need to do is upload the vidjoes to BitView first. There's no charge and we will cover hosting and streaming costs. It's not only a great way to increase user engagement on your site, but it's very easy, and free as well.";
$LANGS['bvsitesection4desc2'] = "Once you have uploaded the vidjoed you can pull them back to the site:";
$LANGS['bvsitesection4desc3'] = "<b>Embed vidjoes one-by-one:</b> Go to the vidjoe that you want to put on your website, and look for the 'Embed' box next to the vidjoe player. Copying the HTML code that's there into your blog will create an embedded player; the vidjoe will play within your site when the user clicks on the 'Play' button.";
...
$LANGS['rssdesc4'] = "BitView offers several RSS feeds for categorized groups of vidjoes (such as recently uploaded, top viewed etc) as well as customized feeds for users and tags.";
$LANGS['rssdesc5'] = "To subscribe to categorized groups of vidjoes, simply go to the category you want (for example, &quot;<a href='/browse'>Most Viewed - Today</a>&quot;). Then click on the orange 'RSS' button. This should trigger your chosen news reader to add the subscription.";
...
$LANGS['flashvideo'] = "Flash Vidjoe";
$LANGS['flashvideodesc'] = "Your browser doesn't support HTML5 vidjoe? Don't worry! Try out our Flash player.";
$LANGS['feather'] = "Feather";
$LANGS['featherdesc'] = "View BitView vidjoed on a super-low latency page.";
