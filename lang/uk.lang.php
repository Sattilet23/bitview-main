...
/* General stuff */
$LANGS['language'] = 'Українська';
$LANGS['languageenglish'] = 'Українська';
$LANGS['languagecode'] = 'uk_UA.UTF-8'; /* Leave the ".UTF-8" in the end as-is, as it might break some dates */
$LANGS['languagechange'] = 'Мова була змінена на Українську';
...
/* Language window */
$LANGS['welcometobitview'] = 'Ласкаво просимо до BitView!';
...
$LANGS['minutes'] = 'хвилин';
$LANGS['hours'] = 'годин';
$LANGS['days'] = 'днів';
$LANGS['weeks'] = 'тижнів';
$LANGS['months'] = 'місяців';
$LANGS['years'] = 'років';
$LANGS['ago'] = '{t} потому';
$LANGS['january'] = 'Січень';
$LANGS['february'] = 'Лютий';
$LANGS['march'] = 'Березень';
$LANGS['april'] = 'Квітень';
$LANGS['may'] = 'Травень';
$LANGS['june'] = 'Червень';
$LANGS['july'] = 'Липень';
$LANGS['august'] = 'Серпень';
$LANGS['september'] = 'Вересень';
$LANGS['october'] = 'Жовтень';
$LANGS['november'] = 'Листопад';
$LANGS['december'] = 'Грудень';
...
/* Header */
$LANGS['home'] = 'Домашня Сторінка';
$LANGS['videos'] = 'Відео';
$LANGS['channels'] = 'Канали';
$LANGS['community'] = 'Спільнота';
$LANGS['search'] = 'Пошук';
$LANGS['login'] = 'Увійти';
$LANGS['or'] = 'або';
$LANGS['signup'] = 'Створити аккаунт';
$LANGS['logout'] = 'Вийти';
$LANGS['upload'] = 'Опубліковати';
$LANGS['subscriptions'] = 'Підписки';
$LANGS['history'] = 'Історія';
$LANGS['account'] = 'Аккаунт';
$LANGS['myvideos'] = 'Мої Відео';
$LANGS['favorites'] = 'Мені подобається';
$LANGS['playlists'] = 'Списки відтворення';
$LANGS['help'] = 'Допомога';
...
$LANGS['signintitle'] = "Увійти";
$LANGS['historytitle'] = "Історія переглядів";
$LANGS['favtitle'] = "Мені подобається";
$LANGS['pltitle'] = "Списки відтворення";
$LANGS['partnerprogram'] = "Партнерська програма";
